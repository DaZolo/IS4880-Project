...
class Newsletter(db.Model):
    ...
    newsletterID = Column(Integer, primary_key=True)
    headlines    = Column(String(255), nullable=False)
    date         = Column(Date,       nullable=False)
    subject      = Column(String(255), nullable=False)
    body         = Column(Text,       nullable=False)

    # these back_populates must match the attribute names on SentTo and Engagement
...
def newsletter_page():
    ...
    # GET: show form + last five newsletters
